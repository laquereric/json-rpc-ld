...
const specContent = `# JSON-RPC-LD: A Linked Data Extension for JSON-RPC 2.0
    ...
    <Layout>
      <div className="max-w-4xl">
        <div className="mb-12 border-b border-gray-200 pb-8">
          <h1 className="text-4xl font-bold tracking-tight mb-4">JSON-RPC-LD Specification</h1>
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 text-sm text-gray-500">
            <div>
              <span className="font-bold text-gray-900">Origin Date:</span>
              <br />
              2025-12-06
            </div>
        ...
        <div className="prose prose-gray max-w-none prose-headings:font-bold prose-h2:text-2xl prose-h2:mt-12 prose-h2:mb-6 prose-h2:pb-2 prose-h2:border-b prose-h2:border-gray-100 prose-a:text-accent prose-a:no-underline hover:prose-a:underline prose-code:text-accent prose-code:bg-accent/5 prose-code:px-1 prose-code:py-0.5 prose-code:rounded-sm prose-pre:bg-[#222] prose-pre:text-gray-300 prose-pre:rounded-sm prose-pre:border prose-pre:border-gray-800">
          <Streamdown>{specContent}</Streamdown>
        </div>
      </div>
    </Layout>
  );
