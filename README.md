...
**Specification repository** -- two layered specs. No
...
- **Validation** -- JSON-RPC-LD mandates SHACL as the validation mechanism but defines no
  specific shapes; a conforming server or profile provides its own shapes graph.
